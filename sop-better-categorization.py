...
def lambda_handler(event, context):
    """SOP workflow with better categorization"""
    ...
    # Process new requests with better categorization
    if any(keyword in message for keyword in ['distribution list', 'dl', 'employees']):
        ...
        # General IT support - don't process as automation
        if channel:
            send_slack_message(channel, "I've received your message. For general IT support, please contact the IT team directly or create a ticket.")
        return {'statusCode': 200, 'body': 'General IT message'}
...
def is_sso_request(message):
    ...
    # Must contain specific SSO keywords
