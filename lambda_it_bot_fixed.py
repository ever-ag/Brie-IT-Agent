...
def handle_sop_sso_request(message, user_id, channel):
    ...
    try:
        ...
        if extract_result['statusCode'] != 200:
            ...
            if channel:
                send_slack_message(channel, "❌ Could not understand your SSO request. Please be more specific.")
        ...
        if channel:
            send_slack_message(channel, f"✅ Your request to add {extracted_data['user_email']} to {extracted_data['group_name']} is being processed. IT will review and approve shortly.")
        ...
        if channel:
            send_slack_message(channel, "❌ There was an issue processing your request. Please contact IT directly.")
...
def trigger_automation_workflow(user_email, user_name, message, channel, thread_ts, automation_type, user_id=None):
    ...
    try:
        ...
        return {
            'success': True,
            'message': f'✅ Your request to add {extracted_data["user_email"]} to {extracted_data["group_name"]} is being processed. IT will review and approve shortly.',
